...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"👤 First Name    : {extracted['first_name'] or 'Not found'}")
        print(f"👤 Surname       : {extracted['surname'] or 'Not found'}")
