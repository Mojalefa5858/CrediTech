...
def main():
    ...
    id_path = "/home/bob/Desktop/Coding/Django/loaner15/myloan/jeff.jpeg"
    payslip_path = "/home/bob/Desktop/Coding/Django/loaner15/myloan/jeffpays.pdf"
    ...
    try:
        ...
        # MODIFIED VERIFICATION LOGIC - Now succeeds if either name matches
        print("\n" + "="*50)
        if id_valid and payslip_valid:
            if first_name and surname:
                first_found, last_found = check_name_match(payslip_text, first_name, surname)
                if first_found or last_found:  # Changed from AND to OR
                    print("✅ VERIFICATION SUCCESS: Valid documents with at least one matching name")
                else:
                    print("⚠️ VERIFICATION WARNING: Valid documents but no name matches")
            else:
