...
class CustomUserCreationForm(UserCreationForm):
    ...
    national_id_number = forms.CharField(max_length=20, widget=forms.TextInput(attrs={'pattern': '[0-9]{9}'}))
...
class UserUpdateForm(forms.ModelForm):
    ...
    def clean_national_id_number(self):
        ...
        if national_id and not national_id.isdigit() or len(national_id) != 9:
            raise forms.ValidationError('National ID must be 9 digits')
        return national_id
